...
(function () {
  ...
  function applyConfig() {
    ...
    setText("resultBody",
      ...
      "רמת הביקורתיות, החשדנות והיסודיות הנדרשת לתפקיד — אינה ניתנת לשכפול בבינה מלאכותית.");
    setText("resultVerdict",
      "החלטת הוועדה: EYAL-9000 סירב לקבל את התפקיד בטענה שמצא 47 ליקויים מהותיים " +
      "במערכת עצמה. אי-לכך, נאלצים להחזירך מחופשת הפרישה ל-" + years + " שנים נוספות.");
